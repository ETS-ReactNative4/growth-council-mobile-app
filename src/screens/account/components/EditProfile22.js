...
const EditProfileForm = (props) => {
    ...
    const {navigation, profile, loading, error, fetchEmployeeByIdentifier, updateCustomer} = props;
                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.body}>
                        ...
                        {/*<FlatOutlineTextInput*/}
                            ...
                            {/*onChangeText={handleChange('passport_issue_date')}*/}
                            {/*onBlur={handleBlur('passport_issue_date')}*/}
                            {/*error={errors.passport_issue_date}*/}
                            {/*touched={touched.passport_issue_date}*/}
                        {/*/>*/}
                        ...
                        {/*<FlatOutlineTextInput*/}
                            ...
                            {/*onChangeText={handleChange('passport_expiry_date')}*/}
                            {/*onBlur={handleBlur('passport_expiry_date')}*/}
                            {/*error={errors.passport_expiry_date}*/}
                            {/*touched={touched.passport_expiry_date}*/}
                        {/*/>*/}
                        ...
                        {/*<FlatOutlineTextInput*/}
                            ...
                            {/*value={values.residency_issue_date}*/}
                            {/*onChangeText={handleChange('residency_issue_date')}*/}
                            {/*onBlur={handleBlur('residency_issue_date')}*/}
                            {/*error={errors.residency_issue_date}*/}
                            {/*touched={touched.residency_issue_date}*/}
                        {/*/>*/}
                        ...
                        {/*<FlatOutlineTextInput*/}
                            ...
                            {/*value={values.residency_expiry_date}*/}
                            {/*onChangeText={handleChange('residency_expiry_date')}*/}
                            {/*onBlur={handleBlur('residency_expiry_date')}*/}
                            {/*error={errors.residency_expiry_date}*/}
                            {/*touched={touched.residency_expiry_date}*/}
                        {/*/>*/}
